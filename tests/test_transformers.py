...
def _make_raw_df(**overrides):
    ...
    base = {
        ...
        # BUG FIX (Bug 7): was missing from the original fixture.
        # Its absence meant TotalDelinquencies was computed over 2 columns
        # instead of 3, and the transformer would not include it in the
        # final 15-feature matrix after the bug fix.
